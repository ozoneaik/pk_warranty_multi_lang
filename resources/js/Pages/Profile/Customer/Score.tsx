...
export default function ScorePage() {
    const { t } = useLanguage();
    const { auth, line_avatar, point, joined_at, tier, tier_expired_at } =
            ...
            >
                ...
                >
                    ...
                    >
                        <Avatar
                            src={
                                line_avatar || "https://via.placeholder.com/64"
                            }
                            sx={{
                    ...
                    <Card
                        ...
                        sx={{
                            ...
                            boxShadow:
                                "0 20px 40px rgba(0,0,0,0.15), inset 0 0 100px rgba(255,255,255,0.5)",
                            border: "none",
                        ...
                        >
                            <List disablePadding>
                                <ListItemButton
                                    onClick={() =>
                                        router.get(
                                            route("customer.profile.info.pdpa"),
                                        )
                                    }
                                    sx={{ py: { xs: 1.5, sm: 2 } }}
                                >
                                ...
                                <ListItemButton
                                    onClick={() =>
                                        router.get(
                                            route("customer.profile.info.term"),
                                        )
                                    }
                                    sx={{ py: { xs: 1.5, sm: 2 } }}
                                >
