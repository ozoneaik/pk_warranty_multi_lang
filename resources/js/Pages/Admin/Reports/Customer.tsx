...
export default function CustomerReport({ stats, customers, history, filters, age_chart, tier_chart }: Props) {
    ...
    // Reusable Stat Card Component
    const StatCard = ({ icon: Icon, title, value, subtitle, gradient, iconBg }: any) => (
        <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${gradient} p-6 shadow-sm border border-transparent hover:shadow-md transition-all duration-300 transform hover:-translate-y-1`}>
            <div className="flex items-start justify-between">
