...
export default function CouponCreate() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        name: '',
        code: '',
        is_auto_generate_code: false,
        member_group: [] as string[],
        birth_month: 'ALL',
        quota_limit_total: '',
        quota_limit_user: '',
        member_type: 'ALL',

        is_link_traffic_source: false,
        ...
        expiry_dynamic_unit: 'DAYS',
        is_expiry_notification: false,
        show_in_new_member_menu: false,

        qr_code_description: '',
        external_link: '',
        redeemed_channels: [] as string[],
    ...
    const handleSwitchChange = (field: keyof typeof data, value: boolean) => {
        const newData: any = { ...data, [field]: value };

        // Logic for Auto Generate Code
        if (field === 'is_auto_generate_code') {
            newData.code = value ? generateRandomCode() : '';
        }
        setData(newData);
    };
                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-3">
                                ...
                                <h1 className="text-3xl font-bold text-gray-900">สร้างคูปองส่วนลด</h1>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 ml-14">
                            ...
                            <p className="text-gray-600">สร้างคูปองส่วนลดเพื่อมอบสิทธิพิเศษให้กับลูกค้า</p>
                        </div>
                    </div>
                                ...
                                <SectionCard title="ข้อมูลพื้นฐาน" icon={Settings}>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            {/* Mock Select - In real app use MultiSelect component */}
                                            <select
                                            ...
                                            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-purple-400 transition-colors relative bg-gray-50 cursor-pointer" onClick={() => document.getElementById('coupon-img')?.click()}>
                                                {(data.image_file) ? (
                                                    <div className="flex flex-col items-center">
                                                        <img src={URL.createObjectURL(data.image_file)} className="h-40 object-contain mb-4 rounded shadow-sm" alt="Preview" />
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                ...
                                                {/* Mock Select */}
                                                <select className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 bg-white">
