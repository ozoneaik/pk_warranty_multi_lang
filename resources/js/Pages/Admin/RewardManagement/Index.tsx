        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center space-x-4">
                    ...
                    <h2 className="font-semibold text-xl text-gray-800 leading-tight">ศูนย์รวมการจัดการสินค้าสิทธิพิเศษ</h2>
                </div>
            }
        >
            <Head title="จัดการสิทธิพิเศษ" />
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6">
                        <h1 className="text-2xl font-bold text-gray-800">ศูนย์รวมการจัดการสินค้าสิทธิพิเศษ</h1>
                        <p className="text-gray-600">เลือกประเภท</p>
                    </div> */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        {sub_menus.length > 0 ? (
                            ...
                            >
                                ...
                                <h3 className="text-lg font-semibold text-gray-900">จัดการของรางวัล</h3>
                                <p className="text-sm text-gray-600 mt-1">สร้างของรางวัล เพิ่ม ลบ แก้ไขของรางวัลในระบบ</p>
                            </Link>
